...
async def chartDashboard(request: Request):
    ...
    data2 = session.execute("SELECT * FROM casos_x_accion()").fetchall()
    data3 = session.execute("SELECT * FROM casos_x_mes()").fetchall()
    data4 = session.execute("SELECT * FROM conteo_tipologia()").fetchall()
    data5 = session.execute("SELECT * FROM casos_x_genero()").fetchall()
    ...
    casos_x_mes_actual = session.execute("SELECT * FROM casos_x_mes_actual()").fetchall()[0]['casos_x_mes_actual']
    casos_x_dia = session.execute("SELECT * FROM casos_x_dia()").fetchall()[0]['casos_x_dia']
    citaciones_x_mes = session.execute("SELECT * FROM citaciones_x_mes()").fetchall()[0]['citaciones_x_mes']
    ...
    suspendidos_x_mes = session.execute("SELECT * FROM suspendidos_x_mes()").fetchall()[0]['suspendidos_x_mes']
